...
%guess the main difficulty is the offset. The deviation could be
%calculated
...
%if Fluo_N_max>1.5*Fluo_N_fit_max || Fluo_N_max<0.5*Fluo_N_fit_max
...
position_difference=Fluo_max_position-DISTORED_max_position;
...
%     
    ...
    %%%This is for standard error of the regression%%%
    residue=[];
    residue=(DISTORED-transpose(Fluo_sub));
    what.residue(:,ddd)=residue(:);   
end
